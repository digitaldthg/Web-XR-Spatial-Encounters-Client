...
UnrealBloomPass.prototype = Object.assign( Object.create( Pass.prototype ), {
    ...
    renderer.getClearColor(color);
		...
		for ( var i = 0; i < this.nMips; i ++ ) {
			...
			this.separableBlurMaterials[ i ].uniforms[ "direction" ].value = new Vector2( 1.0, 0.0 );// UnrealBloomPass.BlurDirectionX;
			renderer.setRenderTarget( this.renderTargetsHorizontal[ i ] );
			renderer.clear();
			renderer.render( this.scene, this.camera );

			this.separableBlurMaterials[ i ].uniforms[ "colorTexture" ].value = this.renderTargetsHorizontal[ i ].texture;
			this.separableBlurMaterials[ i ].uniforms[ "direction" ].value = new Vector2( 0.1, 1.0 );// UnrealBloomPass.BlurDirectionY;
